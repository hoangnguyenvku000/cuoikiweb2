	...
	<div class="top-nav group">
        <section>
            ...
            <ul class="top-nav-quicklink flexContain">
                ...
                <li><a href="trungtambaohanh.html"><i class="fa fa-wrench"></i> Cửa hàng</a></li>
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Viet phuc</a> - All rights reserved © 2024 - Designed by
            <span style="color: #eee; font-weight: bold">me</span></p>
    </div>`);
}
